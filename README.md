...
- For Node.js, You need to have Node.js and npm installed first. You need to run "npm install" to setup needed dependencies TypeScript. You need to run "npm run build" to compile the TypeScript source files to JavaScript before running the Node.js server (or have your IDE do it for you). Otherwise you will get error messages about missing JavaScript files when you open the webapp in your browser.
