...
require(["dojo/_base/lang"], function(lang) {
    ...
    ToDoModule.view = function() {
        ...
        return m("html", [
            m("body", [
                m("input", {onchange: function () {ToDoModule.vm.description = this.value;}, value: ToDoModule.vm.description}),
                m("button", {onclick: ToDoModule.vm.add}, "Add"),
                m("table", [
                    ToDoModule.vm.list.map(function(task, index) {
                        return m("tr", [
                            m("td", [
                                m("input[type=checkbox]", {onclick: function() {task.done = this.checked;}, checked: task.done})
                            ]),
