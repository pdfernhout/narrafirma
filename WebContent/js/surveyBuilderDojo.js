define([
...
], function (array, domStyle, getPlainValue, generateRandomUuid, PanelBuilder, ContentPane, Dialog, StackContainer, Stateful, widgetSupport) {
    "use strict";
    var timestampStart;
    ...
    function newStoryEntry(wizardPane, allStoryQuestions, participantID, surveyResultsWithModels, addIndex, singlePrompt) {
        ...
        if (singlePrompt)
            storyQuestionsModel.set("__survey_elicitingQuestion", singlePrompt);
        ...
        var tellAnotherStoryButton = widgetSupport.newButton(surveyPane, "#button_tellAnotherStory|Tell another story", function () {
            ...
            if (!validateStoryQuestionsModel(storyQuestionsModel))
                return;
        ...
        var dontTellAnotherStoryButton = widgetSupport.newButton(surveyPane, "#button_dontTellAnotherStory|Done with adding stories", function () {
            ...
            if (!validateStoryQuestionsModel(storyQuestionsModel, canProceedIfNoStory))
                return;
            wizardPane.forward();
        });
        /*
