    ...
    var PanelBuilder = declare(null, {
        ...
        createQuestionContentPaneWithPrompt: function (contentPane, fieldSpecification) {
            ...
            if (!fieldSpecification)
                throw new Error("null, undefined, or empty string for fieldSpecification");
            if (!fieldSpecification.id)
                throw new Error("null, undefined, or empty string for fieldSpecification id: " + JSON.stringify(fieldSpecification));
