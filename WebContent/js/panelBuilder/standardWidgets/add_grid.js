define([
    ...
    function add_grid(panelBuilder, contentPane, model, fieldSpecification) {
        ...
        if (!gridConfiguration)
            gridConfiguration = { viewButton: true, addButton: true, removeButton: true, editButton: true, duplicateButton: true, moveUpDownButtons: false, includeAllFields: false };
