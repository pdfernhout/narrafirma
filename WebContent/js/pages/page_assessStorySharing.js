...
define([
    ...
    var questions = [
        ...
        {"id":"assessment_counterStories", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_authority", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_mistakes", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_silencing", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_conflict", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_narrativeFlow", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"assessment_remindings", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_retellings", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_folklore", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_storyTypes", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_sensemaking", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_narrativeKnowledge", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"assessment_realStories", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_negotiations", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_cotelling", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_blunders", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_accounting", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_narrativeUnity", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"assessment_commonStories", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_sacredStories", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_condensedStories", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_intermingling", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_culture", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_result_header", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"assessment_result_freedomSubscore", "type":"quizScoreResult", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_result_flowSubscore", "type":"quizScoreResult", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_result_knowledgeSubscore", "type":"quizScoreResult", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_result_unitySubscore", "type":"quizScoreResult", "isInReport":true, "isGridColumn":false},
        {"id":"assessment_result_grandTotal", "type":"quizScoreResult", "isInReport":true, "isGridColumn":false},
