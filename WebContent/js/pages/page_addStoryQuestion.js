...
define([], function() {
    ...
    var questions = [
        ...
        {"id":"SPECIAL_templates_storyQuestions", "type":"templateList", "isInReport":true, "isGridColumn":false, "options":["storyQuestions"]},
        {"id":"SPECIAL_templates_storyQuestions_unfinished", "type":"label", "isInReport":false, "isGridColumn":false}
    ];
