...
define([
    ...
    var questions = [
        ...
        {"id":"participantGroupAspects_status", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_confidence", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_abilityHeader", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"participantGroupAspects_time", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_education", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_physicalDisabilities", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_emotionalImpairments", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"aspects_expectationsHeader", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"participantGroupAspects_performing", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_conforming", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_promoting", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_venting", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"aspects_feelingsHeader", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"participantGroupAspects_interest", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_feelings_project", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_feelings_facilitator", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_feelings_stories", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"aspects_topicHeader", "type":"header", "isInReport":false, "isGridColumn":false},
        {"id":"participantGroupAspects_topic_feeling", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_topic_private", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_topic_articulate", "type":"select", "isInReport":true, "isGridColumn":false},
        {"id":"participantGroupAspects_topic_timeframe", "type":"select", "isInReport":true, "isGridColumn":false}
    ];
