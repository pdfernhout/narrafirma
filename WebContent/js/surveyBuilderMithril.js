define(["require", "exports", "../lib/dojox/uuid/generateRandomUuid", "../lib/dojo/_base/lang", "../lib/mithril/mithril"], function (require, exports, generateRandomUuid, lang, m) {
    "use strict";
    ...
    function buildSurveyForm(surveyDiv, questionnaire, doneCallback, previewMode) {
        ...
        function displayQuestion(model, fieldSpecification) {
            ...
            function change(event, value) {
                ...
                if (fieldSpecification.id === "__survey_storyName")
                    redraw();
            }
            ...
            if (displayType === "label") {
                ...
                makeLabel();
                parts = [
                    m("input[type=checkbox]", { id: getIdForText(fieldID), checked: value, onchange: function (event) {
                ...
                parts = [
                    fieldSpecification.valueOptions.map(function (option, index) {
                        ...
                        return [
                            m("input[type=checkbox]", { id: optionID, checked: !!value[option], onchange: function (event) {
