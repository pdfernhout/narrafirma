define(["require", "exports", "./questionnaireGeneration", "./pointrel20150417/topic", "./panelBuilder/translate"], function (require, exports, questionnaireGeneration, topic, translate) {
    ...
    function getStoriesForStoryCollection(storyCollectionIdentifier) {
        ...
        var surveyMessages = project.pointrelClient.filterMessages(function (message) {
            var match = (message._topicIdentifier === "surveyResults" && message.messageType === "surveyResult" && message.change.projectIdentifier === project.projectIdentifier && message.change.storyCollectionIdentifier === storyCollectionIdentifier);
    ...
    function storyCollectionStop() {
        ...
        for (var i = 0; i < storyCollections.length; i++) {
            ...
            if (!storyCollection.storyCollection_activeOnWeb)
                continue;
