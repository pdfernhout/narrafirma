 ...
 */
function GridWithItemPanel(panelBuilder: PanelBuilder, pagePane, id, dataStore, itemPanelSpecification, configuration, model) {
    var self = this;
