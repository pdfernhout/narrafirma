...
// TODO: Need to update answer counts in filters if change value in story that affects selected filter question
...
export class StoryBrowser {
    ...
    function loadLatestStories(storyBrowserInstance, allStories) {
        ...
        // Need to update choices in filters or clear them out; resetting value forces update
