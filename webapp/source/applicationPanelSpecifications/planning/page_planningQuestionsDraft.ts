...
const panel: Panel = {
    ...
    displayName: "Answer the PNI planning questions",
    pageExplanation: "Describe your project's goals, topic, people, perspectives, scale, and process.",
    ...
    panelFields: [
        {
            ...
            displayPrompt: `You can use this page to answer some <strong>planning questions</strong> about your project: 
                its goals, topic, people, perspectives, scale, and process. 
