...
export const createNewStoryCollection = manageStoryCollection.createNewStoryCollection;
export const updateQuestionnaireForStoryCollection = manageStoryCollection.updateQuestionnaireForStoryCollection;
export const checkStoryFormsForDataConflicts = manageStoryCollection.checkStoryFormsForDataConflicts;
